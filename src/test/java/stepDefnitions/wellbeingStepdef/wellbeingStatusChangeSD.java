...
public class wellbeingStatusChangeSD extends BaseClass {

	
	@Given("user opens the wellbeing portal {string} and {string}")
	public void user_opens_the_wellbeing_portal_and(String username, String password) {
	...
	public void user_changes_the_status_of_the_survey() {
