...
public class assignComptenciesCondition extends BaseClass {
	...
	public static void main(String[] args) {
        ...
        //page.locator("//mat-icon[text()='filter_list']").click();
...
//        Locator search = page.locator("//div[@class='cdk-overlay-container']//input[@ng-reflect-placeholder='Search']");
//        search.waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.ATTACHED));
//        search.fill(comps[i]);
//        page.locator("(//span[@class='mat-option-text'])[2]").click();
