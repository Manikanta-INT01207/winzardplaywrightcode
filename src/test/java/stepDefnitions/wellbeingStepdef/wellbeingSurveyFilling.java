...
public class wellbeingSurveyFilling extends BaseClass{

	@Given("employee goes to  wellebing portal {string} and {string}")
	public void employee_goes_to_wellebing_portal_and(String usernameeeee, String passwordsss) {
...
//		page.waitForTimeout(3000);
	...
	public void employees_opens_the_survey_to_fil_it() {
	...
	@Then("employee gives the rating and {string} and {string}")
	public void employee_gives_the_rating_and_and(String optionAnswer, String freeTextAnswer) {
