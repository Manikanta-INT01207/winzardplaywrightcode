Feature: verify admin able to create a workflow and assign forms in employee level
...
Then admins adds the employees through filters "<department>" and "<subdepartment>" or "<customemp>" or "<empID>" 
...
Examples:
|username|password|title|forms|weightage|hierarchy|selfforms|RMforms|skiplevelmanagerforms|reviwerlevels|reviewersempIDs|reviewer1forms|reviewer2forms|reviewer3forms|finalauthority|department|subdepartment|customemp|empID|
|anirudha@interbiz.in|Winzard@2024|grade-f workflow|self form,FORM 1|60,40|self,reporting manager,reviewer-1,reviewer-2|self form|FORM 1|no forms|L1,L2|CAP-37,CAP-38|self form,FORM 1|no forms|no forms|reviewer - 2|||CAP-05||